...
def get_endpoints(raw: dict | None = None) -> list[Endpoint]:
    ...
    for e in raw.get("endpoints", []):
        ep = Endpoint(
            ...
            digest_team_days=e.get("digest_team_days", 1),
            digest_event_days=e.get("digest_event_days", 7),
            digest_show_channels=e.get("digest_show_channels", True),
            weekly_digest_time=e.get("weekly_digest_time", "08:00"),
            weekly_digest_day=e.get("weekly_digest_day", "monday"),
            weekly_digest_team_days=e.get("weekly_digest_team_days", 7),
            weekly_digest_event_days=e.get("weekly_digest_event_days", 7),
            weekly_digest_show_channels=e.get("weekly_digest_show_channels", True),
